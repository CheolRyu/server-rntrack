...
const authRoutes = require('./routes/authRoutes.js') //route
...
const mongoUri = 'mongodb+srv://admin:1Su7AUClN5ACmbLB@cluster0.xkogb.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'; //mongo url
